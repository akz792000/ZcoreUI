...
$.widget("ech.multiselect", {
	...
	_create: function(){
		//<ZANDI>
		var ZcoreMultiSelect = $('body').children('#ZcoreMultiSelect:first'); 
		if (ZcoreMultiSelect.length == 0) {
			ZcoreMultiSelect = $('<div>', { id : "ZcoreMultiSelect"});
		...
		var 
			...
			button = (this.button = $('<button tabindex="-1" id="' + this.element.attr('id') + 'Btn" type="button" style="width: 100%; height: 100%"><span class="ui-icon ui-icon-triangle-2-n-s"></span></button>'))
			//</ZANDI>
				.addClass('ui-multiselect ui-widget ui-state-default ui-corner-all')
				//<ZANDI>
				.addClass('ui-multiselect-' + this.options.direction)
				//</ZANDI>						
				.addClass( o.classes )
			...
			buttonlabel = (this.buttonlabel = $('<span />'))
				...
				menu = (this.menu = $('<div />'))					
					.addClass('ui-multiselect-menu ui-widget ui-widget-content ui-corner-all')
					.addClass('ui-multiselect-menu-' + this.options.direction)
					.addClass( o.classes )
			...
			header = (this.header = $('<div />'))
				...
				//<ZANDI>
				.addClass('ui-multiselect-header-' + this.options.direction)
				//</ZANDI>	
				.appendTo( menu ),
	...
	_bindEvents: function(){
		...
		this.menu
			...
			.delegate('input[type="checkbox"], input[type="radio"]', 'click.multiselect', function(e){
				...
				if( this.disabled || self._trigger('click', e, { value: oldVal, text:this.title, checked:checked }) === false ){
					e.preventDefault();
					return;
				}				
				//<ZANDI>
	...
	close: function(){
		...
		if (effect != '')
			...
			this.menu.hide();
		//</ZANDI>
		this.button.removeClass('ui-state-active');//.trigger('blur').trigger('mouseleave'); <ZANDI>
		this._isOpen = false;
		this._trigger('close');
		//<ZANDI>
		//this.button.focus();
