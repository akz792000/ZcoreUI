 ...
 *
 * VERSION 2.1.2
 * Original version: 1.0 آ© 2010 Andrew Valums ( andrew(at)valums.com )
 * Current Maintainer (2.0+): آ© 2012, Ray Nicholus ( fineuploader(at)garstasio.com )
 *
...
qq.FileUploaderBasic = function(o){
    ...
    this._options = {
        ...
        messages: {
            ...
            //sizeError: "{file} is too large, maximum file size is {sizeLimit}.",<ZANDI>
        	typeError: "فایلهای مجاز عبارتند از: {extensions}.",
            sizeError: "حداکثر اندازه فایل {sizeLimit} است.",
            minSizeError: "{file} is too small, minimum file size is {minSizeLimit}.",
            emptyError: "{file} is empty, please select files again without it.",
            noFilesError: "فایلی یافت نشد.",
...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
            ...
            (!this._options.button ? '<div class="qq-upload-button ui-state-default ui-corner-all">{uploadButtonText}</div>' : '') +
        ...
        classes: {
            ...
            success: 'qq-upload-success ui-corner-all',
            fail: 'qq-upload-fail',
        ...
        extraMessages: {
            ...
            tooManyFilesError: "شما می توانید تنها یک فایل انتخاب کنید."
        },
...
qq.UploadButton = function(o){
    this._options = {
        ...
        focusClass: 'qq-upload-button-focus ui-state-active'
    };
...
qq.extend(qq.UploadHandlerXhr.prototype, {
    ...
    _upload: function(id, params){
        ...
        // build query string
        params = params || {};
       // params[this._options.inputName] = name; <comment by ZANDI>
        var queryString = qq.obj2url(params, this._options.action);
    ...
    _onComplete: function(id, xhr){
        ...
        if (xhr.status !== 200){
            this._options.onError(id, name, "XHR returned response code " + xhr.status, xhr);
        }
